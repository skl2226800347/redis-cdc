...
public class ZipListDeserialize extends Deserialize {
    private int zlbyties;
    private int zltail;
    private int zllen;
    private Map<Object,Object> entryMap;
    public ZipListDeserialize(byte dataType,int database,byte timestampType,long timestamp, String key)throws IOException{
    ...
    public void deserializeValue(RedisInputStream is)throws IOException {
        ...
        try {
            ...
            for(int i=0;i<count;i++) {
                ...
                int valuePrevEntryLength = is.readInt();
                System.out.println("valuePrevEntryLength:" + valuePrevEntryLength);
                //1688221856855
                Object entryValue = parseEntry(is);
    ...
    public void setEntryMap(Map<Object, Object> entryMap) {
